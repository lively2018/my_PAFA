...
class MemoryCrossAggregator(nn.Module):
    ...
    def __init__(self, dim, num_heads=8, blocks=1, mlp_ratio=4.,
                 qkv_bias=False, dropout=0., attn_drop=0., drop_path=0., memory_length=4800, key_length=480, updating_policy="random"):
        super().__init__()
        self.blocks = blocks
        ...
        self.memory_bank = IoUMemoryBank(max_length=memory_length, key_length=key_length, updating_policy=updating_policy)
