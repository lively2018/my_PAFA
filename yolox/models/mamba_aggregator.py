...
class MambaAggregator(nn.Module):
    ...
    def __init__(self, in_channels, num_attention_blocks=16, memory_cfg=dict()):
        ...
        self.memory_bank_p3 = MemoryBank(**memory_cfg, sampling_policy="fifo", updating_policy="fifo")
        self.memory_bank_p4 = MemoryBank(**memory_cfg, sampling_policy="fifo", updating_policy="fifo")
        self.memory_bank_p5 = MemoryBank(**memory_cfg, sampling_policy="fifo", updating_policy="fifo")
