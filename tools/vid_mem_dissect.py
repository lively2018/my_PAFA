...
def imagedir_demo(predictor, vis_folder, current_time, args,exp):
    ...
    for ele_id,ele in enumerate(res):
        ...
        pred_info_p3 = head._ref_pred_info_p3.cpu().numpy()
        pred_info_p4 = head._ref_pred_info_p4.cpu().numpy()
        pred_info_p5 = head._ref_pred_info_p5.cpu().numpy()
        logger.info(f"pred_info_p3: {pred_info_p3.shape}, pred_info_p4: {pred_info_p4.shape}, pred_info_p5: {pred_info_p5.shape}")
        logger.info(f"pred_info_p3: {pred_info_p3}, pred_info_p4: {pred_info_p4}, pred_info_p5: {pred_info_p5}")
