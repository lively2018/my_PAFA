...
# Load the data
df = pd.read_csv('/home/kssong/memory_size_result/memory_stats.csv')
...
plt.tight_layout()
plt.savefig('feature_growth_sep.png')
...
axes[-1].set_xlabel('Frame Index')
plt.tight_layout()
plt.savefig('feature_ratio_grow_sep.png')
...
axes[-1].set_xlabel('Frame Index')
plt.tight_layout()
plt.savefig('memory_usage_grow_sep.png')
